...
static const struct pios_usart_cfg pios_xbee_main_cfg = {
    .regs  = USART1,
...
uint32_t i2c_2_bus_id;
void PIOS_I2C_2_bus_ev_irq_handler(void)
{
    /* Call into the generic code to handle the IRQ for this specific device */
    PIOS_I2C_EV_IRQ_Handler(i2c_2_bus_id);
}

void PIOS_I2C_2_bus_er_irq_handler(void)
{
    /* Call into the generic code to handle the IRQ for this specific device */
    PIOS_I2C_ER_IRQ_Handler(i2c_2_bus_id);
}

void I2C2_EV_IRQHandler() __attribute__((alias("PIOS_I2C_2_bus_ev_irq_handler")));
void I2C2_ER_IRQHandler() __attribute__((alias("PIOS_I2C_2_bus_er_irq_handler")));

static const struct pios_i2c_adapter_cfg pios_i2c_2_bus_cfg = {
	    .regs  = I2C2,
	    .remap = GPIO_AF_I2C2,
	    .init  = {
...
#endif // defined(PIOS_INCLUDE_BMP085_I2C) || defined(PIOS_INCLUDE_LPS331AP)
